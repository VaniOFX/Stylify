...
// Set the specified element to be visible
var setVisibleCentered = elementName => el(elementName).style.display = "block";
        ...
        if (this.readyState === 4) {
            ...
            if (zipped_array.length > 0){
                zipped_array.forEach(function (e) {
                    ...
                    res.setAttribute("data-img-class", "result-image img-responsive centered")
        ...
        if (this.readyState === 4) {
            ...
            if (results.length > 0){
                ...
                for (i = 0; i < results.length; i++) {
                    ...
                    console.log(res);
                    el("result-items").appendChild(res);
                }
